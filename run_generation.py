...
class Genny:
    ...
    def __init__(self, mod_path):
        ...
        parser.add_argument(
            "--model_name_or_path",
            default=mod_path,#'../language-modeling/genout/',
            type=str,
            required=False,
        ...
        parser.add_argument(
            "--repetition_penalty", type=float, default=1.3, help="primarily useful for CTRL model; in that case, use 1.2"
        )
    ...
    def main(self, prompt):
        self.seed_count += 1
        self.args.seed = self.seed_count
        set_seed(self.args)
